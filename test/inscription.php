...
if (isset($_POST["signup"])) {
    ...
    if (!empty($username) && !empty($email) && !empty($mdp) && !empty($age) && !empty($tel)) {
        try {
            $requete = $bdd->prepare('INSERT INTO membres(username,mdp,age,tel,email) VALUES(:username,:mdp,:age,:tel,:email)');
            ...
            if (!$result) {
                ...
                $message = "Vous êtes bien enregistré. Votre identifiant est: ";
