    ...
    <div class="header">
      <h1></h1>
       ...
       <ul class="navbar">
        ...
        <li class="nv"> <a href=#news>NEWS</a></li>
       </ul>
        </div>
    </div>
    <hr>
        ...
        <div class="content_about">
           ...
           <div class="content_about">
            <div>
             ...
             <div class="listeRS">
                    <ul class="URS">
                     <li class="RS"><a href="https://web.facebook.com/mouad.rguibi.1"><img style="width:40px"src="efficace/reseau_sociaux/facebook.png"></a></li>
                     <li class="RS"><a href="https://www.instagram.com/mouadrguibi/"><img style="width:75px"src="efficace/reseau_sociaux/insta.png"></a></li>
                     <li class="RS"><a target="_blank" href="https://www.linkedin.com/in/mouad-rguibi-a9969b265/"><img style="width:40px"src="efficace/reseau_sociaux/linkedin.png"></a></li>
                     <li class="RS"> <a href="https://github.com/mouadrguibi"><img style="width:70px"src="efficace/reseau_sociaux/github.png"></a></li>
                    </ul>
                     </div>
            </div> <br>
           </div>
